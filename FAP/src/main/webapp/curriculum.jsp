            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover table-borderless table-primary align-middle">
                    ...
                    <tbody class="table-group-divider">
                        <c:forEach var="item" items="${requestScope.curriculumList}">
                            <tr class="table-primary">
                                <td scope="row">${item.curriculumID}</td>
                                <td>${item.curriculumName}</td>
                                <td>${item.specializationID.specializationID}</td>
                                <td><a class="btn btn-primary" href="CurriculumController?id=${item.curriculumID}&check=edit" role="button">Edit</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="CurriculumController?id=${item.curriculumID}&check=delete" role="button">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
