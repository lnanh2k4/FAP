        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="startDate" id="startDate" value="${requestScope.week.startDate}" readonly>
                </div>
                <div class="form-group">
                    <label for="endDate">End Date</label>
                    <input type="text" class="form-control" name="endDate" id="endDate" value="${requestScope.week.endDate}" readonly>
                </div>
            </div>
            <div class="container">
                <div class="row">
