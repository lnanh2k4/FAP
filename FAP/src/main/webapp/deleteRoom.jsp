...
<head>
    ...
    <style>
        ...
        h1 {
            margin-bottom: 30px;
            color: #dc3545; /* Màu chữ tiêu đề, ví dụ màu cam san hô */
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="roomName" id="roomName"
                           value="${requestScope.room.roomName}" readonly>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <button type="submit" class="btn btn-primary btn-lg col-md-5">Delete</button>
