                ...
                <div class="container">
                    <div class="row">
                        <c:if test="<%= user.getUserID().getRole() == 0%>">
                            <a class="btn btn-primary col-md-3" href="UserController?id=<%= user.getUserID().getUserID()%>&check=edit"
                               role="button">Edit</a>
                            ...
                            <c:if test="<%=user.getUserID().getRole() != 0%>">
                            <a class="btn btn-primary col-md-4" href="UserController?id=<%= user.getUserID().getUserID()%>&check=edit"
                               role="button">Edit</a>
                            <a class="btn btn-primary col-md-4" href="UserController?id=<%= user.getUserID().getUserID()%>&check=delete"
                               role="button">Delete</a>
                            <a class="btn btn-primary col-md-4" href="UserController" role="button">Back
                                to
                                List</a>
                            </c:if>
                    </div>
