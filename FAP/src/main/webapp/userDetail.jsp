                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="fistName" id="fistName"
                                   value="<%= user.getUserID().getFirstName()%>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="lastName">Last Name</label>
                            <input type="text" class="form-control" name="lastName" id="lastName"
                                   value="<%= user.getUserID().getLastName()%>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <c:choose>
                                ...
                                <c:when test="<%= user.getUserID().getRole() == 1%>">
                                    <input type="text" class="form-control" name="role" id="role"
                                           value="Lecturer" readonly>
                                </c:when>
                                <c:when test="<%= user.getUserID().getRole() == 2%>">
                                    <input type="text" class="form-control" name="role" id="role"
                                           value="Academic Staff" readonly>
                                </c:when>
                    ...
                    <c:if test="${requestScope.user.userID.role==0}">
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control" name="semester" id="semester"
                                   value="<%= user.getUserID().getSemester()%>" readonly>
                        </div>
                        <div class="form-group row">
