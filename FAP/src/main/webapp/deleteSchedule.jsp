<%-- 
    ...
    Created on : Jul 6, 2024, 6:28:36 PM
    Author     : Khanh
--%>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="startDate" id="startDate"
                                value="${requestScope.schedule.startDate}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="endDate">End Date</label>
                            <input type="text" class="form-control" name="endDate" id="endDate"
                                value="${requestScope.schedule.endDate}" readonly>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                            ...
                            <a class="btn btn-primary col-md-5" href="ScheduleController" role="button">Back to Schedule List</a>
