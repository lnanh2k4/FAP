    ...
    <body>
        <div class="container">
            ...
            <div class="d-flex justify-content-between mb-3">
                <a name="" id="" class="btn btn-primary" href="SpecializationController?check=add" role="button">Add Specialization</a>
                    ...
                    <tbody class="table-group-divider">
                        <c:forEach var="item" items="${requestScope.specializationList}">
                            <tr class="table-primary">
                                <td scope="row">${item.specializationID}</td>
                                <td>${item.specializationName}</td>
                                <td>${item.majorID.majorID}</td>
                                <td><a class="btn btn-primary" href="SpecializationController?id=${item.specializationID}&check=edit"
                                       role="button">Edit</a>
                                       </td>
                                    <td>
                                    <a class="btn btn-danger"
                                       href="SpecializationController?id=${item.specializationID}&check=delete"
